export default function CrisisHotline() {
    return (
        ...
        <p>
          ...
          the <a href="https://www.crisistextline.org">Crisis Text Line</a>, or contact the <a href="https://www.stompoutbullying.org/helpchat">Stomp Out Bullying HelpChat Line</a>. These
