export default function CrisisApproach() {
    return (
        <section>
        <br /><h2>Are You a Victim of Cyberbullying?</h2>
        ...
        <ul>
          ...
          <li><strong>Report it</strong> -
            If you are in the US, you should report online harassment to your local FBI field office. You can find your local office here. If you feel there is any immediate threat to your personal safety dial 911.  
          </li><br />
          <li><strong>Focus on your online security</strong> -
            As the perpetrator collects more and more information about you it is common that they may try and gain access to your accounts such as social media and email. Having strong passwords and turning on two-factor authentication is key, but there is lots of good advice at <a href="https://www.getsafeonline.org/">Get Safe online</a> and <a href="https://securityplanner.consumerreports.org/">Security planner</a>.  It is also worth reviewing what personal information exists about you online and trying to remove as much as possible. For example Google yourself and see if you can find your address, phone number or places where you regularly spend time.
          </li> <br />
        ...
        <p>Source: <a href="https://www.thecyberhelpline.com/guides/online-harassment-usa">The Cyber Helpline</a></p>
      </section>
    )
}